 ...
 */
async function prepareAndSendTransaction(sender, receiver, feeData) {
 ...
 */
export const nitroBridgePlugin = async (params) => {
    ...
    const transactionResult = await prepareAndSendTransaction(senderAddress, receiverAddress, feeData);
